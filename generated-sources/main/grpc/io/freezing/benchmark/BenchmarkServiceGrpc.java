...
public class BenchmarkServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.freezing.benchmark.BenchmarkService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.freezing.benchmark.Server.BenchmarkRequest,
      io.freezing.benchmark.Server.BenchmarkResponse> METHOD_UNARY_CALL =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "io.freezing.benchmark.BenchmarkService", "UnaryCall"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.freezing.benchmark.Server.BenchmarkRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.freezing.benchmark.Server.BenchmarkResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.freezing.benchmark.Server.BenchmarkRequest,
      io.freezing.benchmark.Server.BenchmarkResponse> METHOD_STREAMING_CALL =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "io.freezing.benchmark.BenchmarkService", "StreamingCall"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.freezing.benchmark.Server.BenchmarkRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.freezing.benchmark.Server.BenchmarkResponse.getDefaultInstance()));
  ...
  public static abstract class BenchmarkServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void unaryCall(io.freezing.benchmark.Server.BenchmarkRequest request,
        io.grpc.stub.StreamObserver<io.freezing.benchmark.Server.BenchmarkResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_UNARY_CALL, responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<io.freezing.benchmark.Server.BenchmarkRequest> streamingCall(
        io.grpc.stub.StreamObserver<io.freezing.benchmark.Server.BenchmarkResponse> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.freezing.benchmark.Server.BenchmarkRequest,
                io.freezing.benchmark.Server.BenchmarkResponse>(
  ...
  public static final class BenchmarkServiceBlockingStub extends io.grpc.stub.AbstractStub<BenchmarkServiceBlockingStub> {
    ...
    /**
     */
    public io.freezing.benchmark.Server.BenchmarkResponse unaryCall(io.freezing.benchmark.Server.BenchmarkRequest request) {
  ...
  public static final class BenchmarkServiceFutureStub extends io.grpc.stub.AbstractStub<BenchmarkServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.freezing.benchmark.Server.BenchmarkResponse> unaryCall(
        io.freezing.benchmark.Server.BenchmarkRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UNARY_CALL:
          serviceImpl.unaryCall((io.freezing.benchmark.Server.BenchmarkRequest) request,
              (io.grpc.stub.StreamObserver<io.freezing.benchmark.Server.BenchmarkResponse>) responseObserver);
          break;
        default:
